...
init python:
    ...
    def get_time():
        return datetime.datetime.now().strftime("%I:%M %p")  # Windows-safe
init python:
    style.default.font = "texting2007.ttf"  # or the exact name of your .ttf file
init python:
    style.default.font = "HELVETICA_EXTRA_COMPRESSED.TTF"
init python:
